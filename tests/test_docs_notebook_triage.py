...
class TestNotebookDocumentationTriage(unittest.TestCase):
    ...
    def test_status_page_records_refreshed_2d_notebook_as_public(self):
        text = STATUS.read_text(encoding="utf-8")
        self.assertIn("current through PR103", text)
    ...
    def test_remaining_quarantined_notebooks_are_excluded_from_sphinx(self):
        ...
        self.assertNotIn("notebooks/pgmuvi_tutorial_2d.ipynb", text)
        for notebook in [
