...
![Comparison of the PSDs recovered by different GP packages for an arbitrary multiperiodic lightcuve. Not only does `pgmuvi` recover both periods accurately, it also localises with great precision.\label{fig:psds}](paper/PSDs_1d.png){ width="40%" }
